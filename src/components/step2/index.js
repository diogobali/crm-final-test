    ...
    const sendFormx = (e) => {
        ...
        const optionsForm = {
            ...
            body: JSON.stringify({
                ...
                time: formInfo.time,
                coverage: formInfo.coverage,
                accommodation: formInfo.accommodation,
                coparticipation: formInfo.coparticipation,
                ...
                <form onSubmit={sendFormx}>
                    ...
                    >
                        ...
                        <div className="content"> 
                                ...
                                <div>
                                    <span>Abrangencia do Plano</span>
                                    <select
                                         disabled={previousPlan == "false" || previousPlan == "none" ? "false" : ""} 
                                         name="coverage"
                                         onChange={valorInput}
                                ...
                                <div>   
                                    <span>Tempo de Permanencia</span>
                                    <select
                                        disabled={previousPlan == "false" || previousPlan == "none" ? "false" : ""} 
                                        name="time"
                                        onChange={valorInput}
                            ...
                            <div className="companyMain">
                                    {comp.map((r) => (
                                        ...
                                        <div className="companyInfos">
                                            <div>
                                                <span>Matriz ou Filial?</span>
                                                <select
                                                    onChange={(e) => tellId(r.id, {tipo: e.target.value})}
                                                >
                                                    <option value="">Selecione...</option>
